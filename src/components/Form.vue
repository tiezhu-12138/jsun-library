                        ...
                        <div class="d-flex flex-wrap justify-content-start">
                            ...
                            style="width: 18rem;">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">Australian Resident: 
                                        {{ card.isAustralian ? 'Yes' : 'No' }}</li>
...
const validatePassword = (blur) => {
    ...
    if (password.length < minLength) {
        ...
        if (blur) errors.value.password = "Password must comtain at least one lowercase character";
    } else if (!hasNumber) {
